...
| `hero_secondary_cta` | Homepage plans and pricing CTA | Commercial intent |
...
Lead submission events include the selected service interest and pricing-plan
context when available, allowing conversion comparison without changing page
content manually.
