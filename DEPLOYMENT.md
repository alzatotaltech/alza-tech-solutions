...
git init
git add .
git commit -m "Launch ALZA website Build 15"
git branch -M main
...
- Phone links call `+971557550081`, WhatsApp links open the same number, and no
  unavailable `@alzatotaltech.com` mailbox appears.
