      ...
      <div className={"container"}>
        ...
        <div className={"resource-grid"}>
          ...
          <article className={"resource-card"}>
            ...
            <Link className={"text-link arrow"} href={"/docs/enterprise-checklist/"}>Open checklist</Link>
          ...
          <article className={"resource-card"}>
            ...
            <Link className={"text-link arrow"} href={"/docs/installation-guide/"}>Open guide</Link>
          ...
          <article className={"resource-card"}>
            ...
            <Link className={"text-link arrow"} href={"/docs/testing-runbook/"}>Open runbook</Link>
