...
export function Footer() {
  return <footer className="site-footer"><div className="container">
    <div className="footer-grid">
      ...
      <div><span className="footer-title">Company</span><div className="footer-links"><Link href="/about/">About</Link><Link href="/services/">Services</Link><Link href="/solutions/">Solutions</Link><Link href="/contact/">Contact</Link></div></div>
