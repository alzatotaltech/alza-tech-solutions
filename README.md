# ALZA Total Tech Solutions — Next.js / React Migration (Build 54)

Build 54 adds a visible premium React/Motion experience layer on top of the completed migration.
...
> **Deployment requirement:** GitHub Pages must use **Settings → Pages → Source: GitHub Actions**. Do not publish `main/(root)`, because that publishes the source repository rather than the compiled Next.js `out/` artifact. See `DEPLOY-GITHUB-PAGES.md`.
