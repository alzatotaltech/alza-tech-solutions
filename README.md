# ALZA website — GitHub Pages Build 15
...
- 23 responsive HTML pages, including three evergreen SEO resources
...
- Published Complete Suite and Email Only monthly/annual licensing tiers
- Qualified unlimited-storage wording with explicit device, job, and tenant caps
- Verified Gmail contact plus direct phone and WhatsApp routes using
  `+971 55 755 0081`; unavailable domain email addresses are excluded
...
Shared markup and all generated pages are controlled by
`tools/build-v15.mjs`. Update the generator, then run:
